...
struct EditProfile: View {
    ...
    var body: some View {
        ...
        .onAppear(){
            new_image = profileController.userProfile!.image
            genreSelected = profileController.userProfile!.favoriteGenre
            username = profileController.userProfile!.username
            
            if let index = genres.firstIndex(where: {$0.0 == genreSelected}){
                genres[index] = setCategory(c: genres[index])
            }
        }
    }
